...
<section class="content-header">
    <h1>Edit Subscription Details
    <div class="pull-right">
        <a class="btn btn-primary" href="{{ url('subscription?id='.$subscription->service_id) }}"> Back</a>
    </div></h1>
</section>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box" >
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" id="form" method="post" action="{{ url('update_subscription/'.$_GET['id']) }}" autocomplete="on" enctype="multipart/form-data">
                    {{ csrf_field() }}
                  <div class="box-body">
<!--                      <div class="form-group">
                    ...
                    <input type="hidden" name="service_id" value="{{$subscription->service_id}}" />
                      <!--Package Start-->
                      <div id="service_package" >
                    <div class="form-group"  >
                        <label for="userName" class="col-sm-2 control-label">Name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  placeholder="Name" value="{{$subscription->subscription_name}}" id="subscription_name" name="subscription_name"  >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control"  placeholder="Price" value="{{$subscription->subscription_price}}" id="subscription_price" name="subscription_price"   >
                      </div>
                    </div>
                          <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea id="editor1"  name="text_to_be_display" rows="10" cols="80">
                                    {{$subscription->text_to_be_display}}
                        </textarea>
                      </div>
                    </div>
                    <div class="card">
...
//                                        echo "<pre>";print_r($condition);exit;
                                        ...
                                        <tr class="input_fields_wrap">
                                            ...
                                            <td class="parameter"><input type="text" name="parameter_detail[{{$i}}][]" id="remark" value="{{$cond[0]}}"class="form-control parameter checkblank serach_val" rows="1"  aria-="true"></td>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                            <label class="">
                              <div class="iradio_minimal-blue" aria-checked="false" aria-disabled="false" style="position: relative;">
                                  <input type="radio" name="is_recurring" value="1" class="minimal" style="position: absolute; opacity: 0;" <?php if($subscription->is_recurring == "yes") echo "checked"; ?>>
                                  <ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins>
                              </div>
                               Yes
                            </label>
                            <label class="">
                              <div class="iradio_minimal-blue " aria-checked="false" aria-disabled="false" style="position: relative;">
                                  <input type="radio" name="is_recurring" value="0" class="minimal" style="position: absolute; opacity: 0;" <?php if($subscription->is_recurring == "no") echo "checked"; ?>>
                                  <ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins>
                              </div>
                               No
                            </label>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <div class="checkbox">
                          <label>
                              <input type="checkbox" name="is_active" id="is_active" class="minimal" <?php if($subscription->is_active == 1) echo "checked"; ?>> 
                          </label>
                        </div>
                      </div>
                    </div>
