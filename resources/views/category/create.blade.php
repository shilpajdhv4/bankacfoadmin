...
<section class="content-header">
    ...
    <div class="pull-right">
        <a class="btn btn-primary" href="category?id=<?php if(isset($_GET['id'])) echo $_GET['id']; ?>"> Back</a>
    </div></h1>
</section>
...
<!--                <div class="box-header">
                   <h3 class="box-title"><b>Vertical Name : {{ Request::route('id') }}</b></h3>
                </div>-->
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" id="form" method="post" action="{{ url('save_category') }}" autocomplete="on" enctype="multipart/form-data">
                    {{ csrf_field() }}
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <select class="form-control select2" id="vertical_id" name="vertical_id" required >
                            ...
                            <option value="{{$vert->id}}" <?php if(isset($_GET['id'])) { if($_GET['id'] == $vert->id) echo "selected"; } ?>>{{$vert->vertical_name}}</option>
                            @endforeach
                        </select>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <input type="text" name="category_name" id="category_name" class="form-control" rows="3" placeholder="Enter ..." required >
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-10">
                        <div class="checkbox">
                          <label>
                              <input type="checkbox" name="is_active" class="minimal" checked=""> <b>  Is Active</b>
                          </label>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="box-footer">
                      <a class="btn btn-default" href="category?id=<?php if(isset($_GET['id'])) echo $_GET['id']; ?>"> Cancel</a>
